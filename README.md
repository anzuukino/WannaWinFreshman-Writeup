...
- Cơ bản là json_decode nó sẽ decode luôn unicode trong biểu diễn octal thành chữ cái vì vậy mình chỉnh lại cái payload của mình từ 
...
- Ngoài lề: ~~Thật ra thì còn 1 cách bypass khá hay nữa mà sau này mình sẽ viết 1 bài riêng về cái này mình nghĩ cách này bypass cũng kha khá <(")~~
# Bài 3 Solite:
